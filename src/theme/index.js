...
const theme = darkMode => ({
    ...
    // orange
    tokenswapOrange: '#FF8F05',
    //green
    connectedGreen: '#27AE60',

    //branded
    metaMaskOrange: '#cba469',

    //specific
    textHover: darkMode ? theme.tokenswapOrange : theme.doveGray,

    // connect button when loggedout
    buttonFaded: darkMode ? '#cba469' : '#737373',
