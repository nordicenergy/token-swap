...
const Title = styled.div`
  ...
  #link {
    text-decoration-color: ${({ theme }) => theme.tokenswapOrange};
  }
  ...
  #title {
    ...
    color: ${({ theme }) => theme.tokenswapOrange};
    :hover {
      color: ${({ theme }) => darken(0.2, theme.tokenswapOrange)};
    }
  }
`;
...
export default function Footer() {
  ...
  return (
    <FooterFrame>
      <FooterElement>
        <Title>
          <Link; id="link"; href="https://tokenswap.io/">
            <h1; id="title">About</h1>
          </Link>
          <Link; id="link"; href="https://docs.tokenswap.io/">
            <h1; id="title">Docs</h1>
          </Link>
          <Link; id="link"; href="https://github.com/TokenSwap">
            <h1; id="title">Code</h1>
          </Link>
        </Title>
      </FooterElement>
